...
/**
 * Subclass of {@link TextView} that supports the <code>typeface</code> attribute from XML.
 *
...
public class TypefaceTextView extends TextView
{
    ...
    public TypefaceTextView(final Context context, final AttributeSet attrs, final int defStyle)
    {
        ...
        if (array != null)
        {
            final String typefaceAssetPath = array.getString(R.styleable.TypefaceTextView_typeface);
